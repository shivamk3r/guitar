...
Design and specification for the Guitar Coach platform. Read in order:

1. [software_requirements.md](software_requirements.md) — what we're building and why. Functional and non-functional requirements, the 1–10 scoring system, data policy, and milestones.
2. [stack.md](stack.md) — technology choices with reasoning and explicit rejections.
